                ...
                <div className=' flex flex-col lg:items-start items-center  '>
                    ...
                    <div className=' flex gap-[21px] w-[400px]  items-center sm:justify-start justify-center lg:mt-[31px] '>
                        ...
                        <div className='flex flex-col gap-[5px] '>
                            ...
                            <p className='sm:w-[327px] w-[250px] sm:h-[30px] h-[30px] font-poppins sm:text-[15px] text-[14px] font-normal leading-[124.5%] text-[#5E6282]'>
                    ...
                    <div className=' flex gap-[21px] w-[400px]  items-center sm:justify-start justify-center lg:mt-[31px] sm:mt-[30px] mt-[45px]'>
