...
function Destinations (){
    ...
    return(
        <>
            <section className="w-[100vw] sm:h-auto h-[1550px] flex justify-center  lg:mt-[143px] sm:mt-[103px] -mt-[143px]    " >
                <div className="w-[1228px] h-[525px]   ">
                 ...
                 <div className='flex sm:flex-row  flex-col sm:h-auto h-[1300px] sm:gap-0  gap-[200px] justify-between items-center lg:gap-[20px] sm:justify-center sm:bg-[url("/src/svg/destinations/decore.svg")]   bg-no-repeat bg-auto md:bg-[88%_30%] bg-[97%_0%]'> 
                        ...
                        <div  className='lg:w-[314px] md:w-[260px] sm:w-[230px]  w-[400px] sm:h-[457px] h-[300px]  relative rounded-[24px]'> 
                                ...
                                <div className='flex gap-[10px] rounded-bl-[24px]  pt-[20px] pl-[10px] md:-ml-[10px] sm:-ml-[15px] lg:-ml-[2px] pr-[10px] shadow-xl rounded-br-[24px] flex-col md:w-[173px] sm:w-[154px] w-[267px] lg:w-[210px] bg-[#FFFFFF] sm:h-[100px] h-[110px] ml-[13px] absolute   sm:bottom-[195px] -bottom-[90px] md:bottom-[135px] left-[53px]'>
